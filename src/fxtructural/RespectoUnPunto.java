...
public class RespectoUnPunto extends VBox {
    ...
    public VBox RespectoUnPunto(){
        ...
        vbDetalle.getChildren().addAll(lblLambda, lblMomento, lblResultado);
        ...
        btnCalcular.setOnAction((ActionEvent e) -> {
            ...
            lblLambda.setText("λ Lambda = "+df.format(lambdax) +","+df.format(lambday)+","+df.format(lambdaz));
            lblMomento.setText("Momento:");
            lblResultado.setText(df.format(momentoi)+" i , "+df.format(momentoj)+" j , "+df.format(momentok)+" k");
        ...
        vBox.getChildren().addAll(label1,hBox, label2, hBox2, hBox3, btnCalcular, vbDetalle);
